class CollectionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @collection.save
        format.html { redirect_to [@collection.site, @collection], notice: 'Collection was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @collection.update(collection_params)
        format.html { redirect_to [@collection.site, @collection], notice: 'Collection was successfully updated.' }
